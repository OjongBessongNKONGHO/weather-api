...
# The limiter identifies each consumer by their IP address.
# In a multi-tenant API you would identify by API key instead —
# but IP is sufficient for a portfolio project and honest to include.
